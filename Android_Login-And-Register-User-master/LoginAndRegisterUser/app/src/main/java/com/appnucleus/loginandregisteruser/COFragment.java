...
public class COFragment extends Fragment implements OnChartGestureListener,
        OnChartValueSelectedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View chart_co =  inflater.inflate(R.layout.fragment_co, container, false);
        mChart = (LineChart) chart_co.findViewById(R.id.linechart5);
