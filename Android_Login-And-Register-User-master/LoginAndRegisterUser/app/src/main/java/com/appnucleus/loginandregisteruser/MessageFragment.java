...
public class MessageFragment extends Fragment implements OnChartGestureListener,
        OnChartValueSelectedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View chart_message = inflater.inflate(R.layout.fragment_message, container, false);

        mChart = (LineChart) chart_message.findViewById(R.id.linechart1);
