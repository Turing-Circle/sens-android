...
{
	private static String base_URL = "http://sens-agriculture.herokuapp.com/userdata?uname='name2'&pass='pass2'";		//Default configuration for WAMP - 80 is default port for WAMP and 10.0.2.2 is localhost IP in Android Emulator
